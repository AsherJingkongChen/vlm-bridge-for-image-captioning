...
Key Features:
- Uses facebook/dinov2-large (304M parameters)
- Outputs visual features of shape [batch_size, seq_len, 1024]
...
class VisionEncoder(nn.Module):
    ...
    def __init__(
        self, model_name: str = "facebook/dinov2-large", device: Optional[str] = None
    ):
        """
        ...
        self.hidden_size = self.model.config.hidden_size  # 1024 for ViT-L/14
    ...
    def forward(self, images: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            Visual features of shape [batch_size, seq_len, 1024]
    ...
    def get_cls_features(self, images: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            CLS features of shape [batch_size, 1024]
        """
    ...
    def get_patch_features(self, images: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            Patch features of shape [batch_size, 256, 1024]
        """
        features = self.forward(images)
