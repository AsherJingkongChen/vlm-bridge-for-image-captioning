...
class FullModel(nn.Module):
    ...
    def generate_caption(self,
        ...
        with torch.no_grad():
            ...
            input_ids = torch.tensor([[self.language_model.tokenizer.bos_token_id]]).to(self.device)
            ...
            for _ in range(max_length):
                ...
                enhanced_embeddings = self.bridge_module(vision_features, text_embeddings)
                
                # Generate logits through language model
                logits = self.language_model.forward_from_embeddings(enhanced_embeddings)
            ...
            caption = caption.replace(self.language_model.tokenizer.bos_token, "").strip()
            caption = caption.replace(self.language_model.tokenizer.eos_token, "").strip()
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        total_params = (vision_info['num_parameters'] + 
